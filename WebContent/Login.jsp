...
<title>Hệ thống quản lý nhà xe Đại Học Bách Khoa Đà Nẵng</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="well">
					<form class="form-login" role="form" action="doLogin" method="post">
						...
						<div class="form-group checkbox">
							<label> <input type="checkbox" value="remember-me">Ghi
								nhớ
							</label> <a href="QuenMatKhau.jsp">    Quên mật khẩu </a>
						</div>
